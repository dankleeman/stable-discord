...
## [1.1.-] - '2023-XX-XX'
### Added
    - Increased unit test coverage to 25%.
    - Added mypy to lint checks and resolved all mypy concerns.
    - Added config.toml support for output_img_dir to direct where output image should be saved.
## [1.0.0] - '2023-08-11'
### Added
